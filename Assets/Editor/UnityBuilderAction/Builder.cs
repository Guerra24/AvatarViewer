...
namespace UnityBuilderAction
{
  static class Builder
  {
    public static void BuildProject()
    {
      ...
      // Perform build
      BuildPipeline.BuildAssetBundles("Assets/StreamingAssets", BuildAssetBundleOptions.StrictMode | BuildAssetBundleOptions.ChunkBasedCompression, buildPlayerOptions.target);
